...
<head>
    ...
    <title>Zoetrope Admin Panel</title>
            ...
            <div class="container-fluid">
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="header-logo col-auto">
                        <a href="index.html" class="" style="width:50px">
                            <img src="{{ asset('media_asset/zoetrope-logo.gif') }} " alt="logo">
                            <img src="{{ asset('media_asset/zoetrope-logo.gif') }} " class="logo-light w-10"
                                alt="logo">
                        </a>
                                ...
                                <ul class="header-notification-area">
                                    ...
                                    <li class="adomx-dropdown position-relative col-auto">
                                        <a class="toggle" href="#"><img class="lang-flag"
                                                src="{{ asset('backend/assets/images/flags/flag-1.jpg') }}"
                                        ...
                                        <ul class="adomx-dropdown-menu dropdown-menu-language">
                                            <li><a href="#"><img
                                                        ...
                                                        alt=""> English</a></li>
                                            <li><a href="#"><img
                                                        src="{{ asset('backend/assets/images/flags/flag-2.jpg') }}"
                                                        alt=""> Japanese</a></li>
                                            <li><a href="#"><img
                                                        src="{{ asset('backend/assets/images/flags/flag-3.jpg') }}"
                                                        alt=""> Spanish </a></li>
                                            <li><a href="#"><img
                                                        src="{{ asset('backend/assets/images/flags/flag-4.jpg') }}"
                                                        alt=""> Germany</a></li>
                                        </ul>
                                            ...
                                            <div class="body custom-scroll">
                                                <ul>
                                                    <li>
                                                        <a href="#">
                                                            <div class="image"><img
                                                                    src="{{ asset('backend/assets/images/avatar/avatar-2.jpg') }}"
                                                                    alt=""></div>
                                                            <div class="content">
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="image"><img
                                                                    src="{{ asset('backend/assets/images/avatar/avatar-1.jpg') }}"
                                                                    alt=""></div>
                                                            <div class="content">
                                    ...
                                    <li class="adomx-dropdown col-auto">
                                        ...
                                        <div class="adomx-dropdown-menu dropdown-menu-user">
                                            ...
                                            <div class="body">
                                                <ul>
                                                    <li><a href="#"><i class="zmdi zmdi-account"></i>Profile</a>
                                                    </li>
                                                    <li><a href="#"><i
                                                                class="zmdi zmdi-email-open"></i>Inbox</a></li>
                                                    <li><a href="#"><i
                                                                class="zmdi zmdi-wallpaper"></i>Activity</a></li>
                                                </ul>
                                                <ul>
                                                    <li><a href="#"><i class="zmdi zmdi-paypal"></i>Payment</a>
                                                    </li>
                                                    <li><a href="#"><i
                                                                class="zmdi zmdi-google-pages"></i>Invoice</a></li>
                                                </ul>
                                                <ul>
                                                    <li><a href="#"><i
                                                        class="zmdi zmdi-settings"></i>Setting</a></li>
                                                    <li><a href="{{route('admin.logout')}}"><i class="zmdi zmdi-lock-open"></i>Log
                                                    out</a></li>
                                                </ul>
                                            </div>
                                        </div>
            ...
            <div class="side-header-inner custom-scroll">
                ...
                <nav class="side-header-menu" id="side-header-menu">
                    <ul>
                        ...
                        <li class="has-sub-menu"><a href="#"><i class="ti-pie-chart"></i>
                                <span>Charts</span></a>
                            <ul class="side-header-sub-menu">
